...
abstract class $AddressEntityCopyWith<$Res> {
  ...
  $Res call(
      ...
      String city,
      String zipcode,
      @JsonKey(name: 'geo') GeoEntity geo});
...
class _$_AddressEntity extends _AddressEntity {
...
abstract class _AddressEntity extends AddressEntity {
  const factory _AddressEntity(
      {required final String street,
      required final String suite,
      required final String city,
      required final String zipcode,
      @JsonKey(name: 'geo') required final GeoEntity geo}) = _$_AddressEntity;
  const _AddressEntity._() : super._();
