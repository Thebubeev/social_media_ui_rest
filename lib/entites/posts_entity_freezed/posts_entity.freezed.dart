...
PostsEntity _$PostsEntityFromJson(Map<String, dynamic> json) {
  return _PostsEntity.fromJson(json);
}
...
class _$_PostsEntity implements _PostsEntity {
  ...
  factory _$_PostsEntity.fromJson(Map<String, dynamic> json) =>
      _$$_PostsEntityFromJson(json);
...
abstract class _PostsEntity implements PostsEntity {
  const factory _PostsEntity(
      ...
      required final String body}) = _$_PostsEntity;

  factory _PostsEntity.fromJson(Map<String, dynamic> json) =
      _$_PostsEntity.fromJson;
